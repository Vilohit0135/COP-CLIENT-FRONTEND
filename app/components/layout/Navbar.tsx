      ...
      <div className="px-3 py-2.5 bg-transparent">
        ...
        >
          ...
          <div className="flex items-center gap-6">
            ...
            {isClient && isLoggedIn ? (
              <div className="hidden sm:flex rounded-full w-9 h-9 border border-white/50 overflow-hidden cursor-pointer bg-white/20 hover:bg-white/30 transition items-center justify-center">
