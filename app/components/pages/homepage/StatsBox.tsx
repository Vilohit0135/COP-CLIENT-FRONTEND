    ...
    >
      ...
      <div className="flex flex-row items-center justify-between gap-1">
        ...
        <div className="flex flex-col items-center justify-center text-center flex-1 min-w-0">
          <img src="/Container (52).webp" alt="Students" width={44} height={44} loading="lazy" decoding="async" style={{ height: "clamp(24px,5vw,44px)", width: "auto", marginBottom: 4, objectFit: "contain" }} />
        ...
        {/* Stat 2: Counselling */}
        <div className="flex flex-col items-center justify-center text-center flex-1 min-w-0">
          <img src="/Container (53).webp" alt="Counselling" width={44} height={44} loading="lazy" decoding="async" style={{ height: "clamp(24px,5vw,44px)", width: "auto", marginBottom: 4, objectFit: "contain" }} />
        ...
        {/* Stat 3: Partners */}
        <div className="flex flex-col items-center justify-center text-center flex-1 min-w-0">
          <img src="/Container (54).webp" alt="Partners" width={44} height={44} loading="lazy" decoding="async" style={{ height: "clamp(24px,5vw,44px)", width: "auto", marginBottom: 4, objectFit: "contain" }} />
        ...
        {/* Stat 4: Rating */}
        <div className="flex flex-col items-center justify-center text-center flex-1 min-w-0">
          <img src="/Container (55).webp" alt="Rating" width={44} height={44} loading="lazy" decoding="async" style={{ height: "clamp(24px,5vw,44px)", width: "auto", marginBottom: 4, objectFit: "contain" }} />
