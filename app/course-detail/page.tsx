    ...
    <main className="min-h-screen bg-white font-sans text-gray-900 overflow-x-hidden">
      ...
      <section className="bg-white py-24">
        <div className="max-w-[1240px] mx-auto px-4">
          <div className="bg-[#FAF9FF] rounded-[48px] p-8 md:p-16 flex flex-col lg:flex-row gap-16 border border-gray-100">
            <div className="lg:w-1/2 space-y-8">
              <h2 className="text-4xl font-black text-[#1A1A2E] uppercase tracking-tight leading-[1.1]">
                Talk to our expert <br/> on <span className="text-[#8B5CF6]">University Selection</span>
              </h2>
              <p className="text-gray-500 text-sm leading-relaxed max-w-md">
                Confused about your career path? Get a free consultation with our senior advisors who have helped thousands of students achieve their dreams.
              </p>
              <div className="relative rounded-3xl overflow-hidden shadow-xl aspect-video max-w-md">
                <img src="https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=800&auto=format&fit=crop&q=60" className="w-full h-full object-cover" alt="Meeting" />
                <div className="absolute inset-0 bg-purple-900/10" />
              </div>
              <div className="grid grid-cols-2 gap-4">
                 <div className="space-y-1">
                    <p className="text-[10px] font-black text-gray-400 uppercase tracking-tighter">Call Us</p>
                    <p className="text-sm font-black text-[#1A1A2E]">+91 000 000 0000</p>
                 </div>
                 <div className="space-y-1">
                    <p className="text-[10px] font-black text-gray-400 uppercase tracking-tighter">Email Us</p>
                    <p className="text-sm font-black text-[#1A1A2E]">expert@collegeprogram.in</p>
                 </div>
              </div>
            </div>
            
            <div className="lg:w-1/2">
              <div className="bg-white p-10 rounded-[40px] shadow-2xl shadow-purple-100/50 border border-gray-50">
                <h3 className="text-xl font-black mb-8 uppercase text-gray-800">Inquiry Form</h3>
                <form className="space-y-4">
                  <input type="text" placeholder="Full Name" className="w-full px-6 py-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-[#8B5CF6] transition-all outline-none text-sm font-medium" />
                  <input type="email" placeholder="Email Address" className="w-full px-6 py-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-[#8B5CF6] transition-all outline-none text-sm font-medium" />
                  <input type="tel" placeholder="Mobile Number" className="w-full px-6 py-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-[#8B5CF6] transition-all outline-none text-sm font-medium" />
                  <select className="w-full px-6 py-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-[#8B5CF6] transition-all outline-none text-sm font-medium appearance-none">
                    <option>Select Course</option>
                    <option selected>{course.name}</option>
                  </select>
                  <button className="w-full py-4 bg-[#8B5CF6] text-white font-black rounded-2xl uppercase tracking-widest text-xs shadow-xl shadow-purple-200 transition-all hover:bg-[#7C3AED] active:scale-[0.98]">
                    Submit Request
                  </button>
                </form>
              </div>
